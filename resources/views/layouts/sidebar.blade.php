<aside class="p-3 sidebar"
    id="sidebar"style="position: fixed; top: 56px; width: 250px; height: calc(100vh - 56px); overflow-y: auto;">
    <ul class="nav flex-column gap-4">
        ...
        <li class="nav-item shadow">
            <a href="{{ route('connection') }}"
                class="nav-link text-black {{ request()->is('connection') ? 'active' : '' }}"><i
                    class="fas fa-chart-line me-2"></i>connection</a>
        </li>
        ...
        <li class="nav-item shadow">
            <a href="{{ route('connection.add') }}"
                class="nav-link text-black {{ request()->is('connection/add') ? 'active' : '' }}"><i
                    class="fas fa-chart-line me-2"></i>Add Connection</a>
        </li>
        ...
        <li class="nav-item shadow">
            <a href="#" class="nav-link text-black {{ request()->is('search') ? 'active' : '' }}"><i
                    class="fas fa-search me-2"></i>Search</a>
        </li>
        {{-- <li class="nav-item shadow">
        ...
        <li class="nav-item shadow">
            <a href="{{ route('user.shortlist') }}"
                ...
                <i class="fas fa-user me-2"></i>Short List
            </a>
        </li>
        <li class="nav-item shadow">
            <a href="{{ route('user.ignorelist') }}"
                class="nav-link text-black {{ request()->routeIs('user.ignorelist') ? 'active' : '' }}">
                <i class="fas fa-cog me-2"></i>Ignore List
            </a>
        </li>
        <li class="nav-item shadow">
            <a href="#" class="nav-link text-black {{ request()->is('help') ? 'active' : '' }}"><i
                    class="fas fa-question-circle me-2"></i>Help & Support
            </a>
        </li>
